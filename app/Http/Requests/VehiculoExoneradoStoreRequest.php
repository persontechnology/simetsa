<?php
// app/Http/Requests/VehiculoExoneradoStoreRequest.php
...
/**
 * Validación para registrar un vehículo exonerado (Art. 27 Ordenanza SIMETSA).
 */
class VehiculoExoneradoStoreRequest extends FormRequest
{
    ...
    {
        return [
            'tiempo_maximo_horas.max' => 'El tiempo máximo de exoneración es 2 horas (Art. 27).',
        ];
    }
}
