			...
			<div class="sidebar-content">
				...
				<div class="sidebar-section">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        {{-- personas --}}
                        @canany(['usuarios.ver', 'roles.ver', 'conductores.ver', 'agentes.ver', 'puntos_venta.ver'])
                        ...
                        {{-- Catálogos --}}
                        @canany(['zonas.ver', 'calles.ver', 'tarifas.ver', 'horarios.ver', 'parametros.ver','tipos_plaza.ver','dias-feriado.ver', 'manzanas.ver'])
						...
						@canany(['agentes.ver', 'puntos_venta.ver','cursos_capacitacion.ver','agentes_parqueo.ver','solicitudes-punto-venta.ver','solicitudes-agente.ver'])
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav-group-sub collapse">
                                @can('infracciones.ver')
                                    <li class="nav-item"><a href="#" class="nav-link">Infracciones</a></li>
                                @endcan
                                @can('multas.ver')
