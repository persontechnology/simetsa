...
return [
    ...
    /*
     * Interruptor de envío FCM.
     * false → EnviarNotificacionFCMJob marca la notificación como omitida sin llamar a Firebase.
     * true  → Envía via Firebase (requiere FIREBASE_CREDENTIALS válido).
     */
